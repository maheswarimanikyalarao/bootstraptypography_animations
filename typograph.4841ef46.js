...
})({"4Nd7p":[function(require,module,exports,__globalThis) {
...
// Hero Text Animation
(0, _gsapDefault.default).from(".animated-text", {
    opacity: 0,
    y: 100,
    duration: 1.5,
    ease: "power3.out"
...
(0, _gsapDefault.default).to(".geometric-circle", {
    x: 300,
    y: 200,
    duration: 3,
    repeat: -1,
...
(0, _gsapDefault.default).to(".geometric-square", {
    rotation: 360,
    duration: 5,
    repeat: -1,
    ease: "linear"
...
},{"./gsap-core.js":"evdHe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["4Nd7p","3Aj1C"], "3Aj1C", "parcelRequire0b80")

//# sourceMappingURL=typograph.4841ef46.js.map
